...
<div class="sbox">
	...
	<div class="sbox-content"> 	
		...
		<ul class="parsley-error-list">
		 ...
		 {!! Form::open(array('url'=>'nalogzamrijest/save?return='.$return, 'class'=>'form-horizontal','files' => true , 'parsley-validate'=>'','novalidate'=>' ')) !!}
<div class="col-md-12">
						<fieldset><legend> nalogzamrijest</legend>
				...
				<div class="input-group m-b" style="width:150px !important;">
					...
					<span class="input-group-addon"><i class="fa fa-calendar"></i></span>
									  ...
									  <div class="form-group  " >
										<label for="Radnici" class=" control-label col-md-4 text-left"> Radnici </label>
										<div class="col-md-7">
			...
			<div style="clear:both"></div>	
				  ...
				  <div class="form-group">
					...
					<button type="button" onclick="location.href='{{ URL::to('nalogzamrijest?return='.$return) }}' " class="btn btn-warning btn-sm "><i class="icon-cancel-circle2 "></i>  {{ Lang::get('core.sb_cancel') }} </button>
					</div>	  
   ...
   <script type="text/javascript">
	$(document).ready(function() { 
		...
		$("#id").jCombo("{!! url('nalogzamrijest/comboselect?filter=tb_users:id:first_name|last_name') !!}",
		{  selected_value : '{{ $row["id"] }}' });
		 

		$('.removeMultiFiles').on('click',function(){
			var removeUrl = '{{ url("nalogzamrijest/removefiles?file=")}}'+$(this).attr('url');
			$(this).parent().remove();
