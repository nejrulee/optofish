...
<div class="sbox">
	...
	<div class="sbox-content"> 	
		...
		<ul class="parsley-error-list">
		 ...
		 {!! Form::open(array('url'=>'nzriba/save?return='.$return, 'class'=>'form-horizontal','files' => true , 'parsley-validate'=>'','novalidate'=>' ')) !!}
<div class="col-md-12">
						<fieldset><legend> Riba-Nalog</legend>
				{!! Form::hidden('riba_id', $row['riba_id']) !!}					
						     ...
						     class='form-control ' /> 
									  ...
									  <div class="form-group  " >
										<label for="Radnik" class=" control-label col-md-4 text-left"> Radnik </label>
										<div class="col-md-7">
			...
			<div style="clear:both"></div>	
				  ...
				  <div class="form-group">
					...
					<button type="button" onclick="location.href='{{ URL::to('nzriba?return='.$return) }}' " class="btn btn-warning btn-sm "><i class="icon-cancel-circle2 "></i>  {{ Lang::get('core.sb_cancel') }} </button>
					</div>	  
   ...
   <script type="text/javascript">
	$(document).ready(function() { 
		...
		$("#id").jCombo("{!! url('nzriba/comboselect?filter=tb_users:id:first_name|last_name') !!}",
		{  selected_value : '{{ $row["id"] }}' });
		 

		$('.removeMultiFiles').on('click',function(){
			var removeUrl = '{{ url("nzriba/removefiles?file=")}}'+$(this).attr('url');
			$(this).parent().remove();
