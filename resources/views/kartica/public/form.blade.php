		 ...
		 {!! Form::open(array('url'=>'kartica/savepublic', 'class'=>'form-horizontal','files' => true , 'parsley-validate'=>'','novalidate'=>' ')) !!}
				...
				<div class="input-group m-b" style="width:150px !important;">
					...
					<span class="input-group-addon"><i class="fa fa-calendar"></i></span>
						     ...
						     class='form-control ' /> 
									  ...
									  <div class="form-group  " >
										<label for="Current State" class=" control-label col-md-4 text-left"> Current State </label>
										<div class="col-md-7">
										  <input  type='text' name='current_state' id='current_state' value='{{ $row['current_state'] }}' 
						     class='form-control ' /> 
										 </div> 
										 <div class="col-md-1">
				           ...
				           >{{ $row['note'] }}</textarea> 
									  ...
									  <div class="form-group  " >
										<label for="Min Quantity" class=" control-label col-md-4 text-left"> Min Quantity </label>
										<div class="col-md-7">
										  <input  type='text' name='min_quantity' id='min_quantity' value='{{ $row['min_quantity'] }}' 
						     class='form-control ' /> 
										 </div> 
										 <div class="col-md-1">
